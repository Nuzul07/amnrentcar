...
public class rentalmobil
{
    ...
    public static void change()
    {
        ...
        if (check == true) {
            ...
            tr.ttlAU = tr.ttl;
            tr.calcuC();
            if (tr.ttlAU < tr.ttlBU)
            {
                if (tr.payB != 0)
                {
                    System.out.println();
                    System.out.println("--------------------------------------------------");
                    System.out.println("Anda berhasil mendapatkan cashback : Rp."+tr.payB);
                    System.out.println("--------------------------------------------------");
                }
                ls.add(tr);
                hm.put(tr.kdbk, ls);
            ...
            {
                System.out.println("Sisa nominal harga yang harus dibayar : Rp." + tr.ttl);
                System.out.print("Bayar : ");
                tr.pay = input.nextInt();
                if (tr.pay < tr.ttl) {
                    for (int i = 0; i < 3; i++) {
